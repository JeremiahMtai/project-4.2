...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="mada/assets/css/fontawesome.css">
    <link rel="stylesheet" href="mada/assets/css/templatemo-finance-business.css">
    <link rel="stylesheet" href="mada/assets/css/owl.css">
<!--
  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="index.html"><h2>Micro Sacco</h2></a>
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#call_us">Contact Us</a>
              </li>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="service-item">
                <img src="mada/assets/images/service_01.jpg" alt="">
            ...
            <div class="col-md-4">
              <div class="service-item">
                <img src="mada/assets/images/service_02.jpg" alt="">
                <div class="down-content">
            ...
            <div class="col-md-4">
              <div class="service-item">
                <img src="mada/assets/images/service_03.jpg" alt="">
                <div class="down-content">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="left-image">
                    <img src="mada/assets/images/more-info.jpg" alt="">
                  </div>
                </div>
                <div class="col-md-6 align-self-center">
          ...
          <div class="col-md-12">
            <div class="owl-partners owl-carousel">
              ...
              <div class="partner-item">
                <img src="mada/assets/images/client-01.png" title="1" alt="1">
              </div>
              
              <div class="partner-item">
                <img src="mada/assets/images/client-01.png" title="2" alt="2">
              </div>
              
              <div class="partner-item">
                <img src="mada/assets/images/client-01.png" title="3" alt="3">
              </div>
              
              <div class="partner-item">
                <img src="mada/assets/images/client-01.png" title="4" alt="4">
              </div>
              
              <div class="partner-item">
                <img src="mada/assets/images/client-01.png" title="5" alt="5">
              </div>
    ...
    <script src="mada/vendor/jquery/jquery.min.js"></script>
    <script src="mada/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- Additional Scripts -->
    <script src="mada/assets/js/custom.js"></script>
    <script src="mada/assets/js/owl.js"></script>
    <script src="mada/assets/js/slick.js"></script>
    <script src="mada/assets/js/accordions.js"></script>
